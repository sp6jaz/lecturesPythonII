...
2. Utwórz notebook `lab03_numpy.ipynb`
...
**Zadania** (napisz kod i wyświetl wynik):
...
**Zadanie 6 (bonus):** Ranking
```python
# Posortuj produkty od najdroższego do najtańszego
# Podpowiedź: np.argsort() zwraca indeksy sortowania
```
